...
type: post
summary: "The sixth section is also an art class, this time focused on writing functions and using the functional programming toolkit in the purrr package. There is also some art though, I promise!"
---
