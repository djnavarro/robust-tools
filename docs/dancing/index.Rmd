...
meta() %>%
  meta_general(
    description = "A dance with data using dplyr",
  ) %>% 
...
- open script `exercise_tidying_05.R`
...
- open script `exercise_tidying_06.R`
...
.pull-left-narrow[
  <br><br><br>
  .hand[<span style="font-size:40pt">exercise #8</span>]
]
