...
# STAGE 7: initial version of grow_many() uses a FOR loop. Talk them through the 
# [[ ]] notation for lists and then show the output by calling grow_many(tips)

# STAGE 8: introduce the purrr::map() function and verify that it gives the 
# same answer

# STAGE 9: show that map_dfr() is a handy way of binding everything 
# into a single tibble! And...
...
# STAGE 9... use grow_many() instead of grow_from
