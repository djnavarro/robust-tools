...
# STAGE 10a ... move the "tree growing" steps into their own function
#
# grow_tree <- function() {
#   
#   # initialise
...
# STAGE 11... notice that the "tree growth" is also something that
# occurs in a loop, and write it as a FOR loop
#
# grow_tree <- function() {
#   
#   # parameter values
...
# STAGE 10b ... and move the "tree drawing" steps into their own function
