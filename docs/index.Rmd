...
The nine-week course is built around a series of six two-hour workshops, covering the following topics
...
During **Weeks 1-4** we will cover the first four modules. **Week 5** will be left as a "flex" week in which students can discuss their project proposals with me, ask questions or catch up on material they may have missed earlier. **Weeks 6-7** cover the final two modules. **Week 8** is left as second "flex" week to cover additional materials or answer questions students may have. **Week 9** is set aside for students to present their projects. 
