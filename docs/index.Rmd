...
The sixth section is also an [art class](functionality), this time focused on writing functions and using the functional programming toolkit in the purrr package.
